...
from trainer.slim_contrast_trainer import csd_train
...
if __name__ == '__main__':
    ...
    ### Train baseline
    train(training_data_loader, net, opt, testing_data_loader)

    ### Train CSD
    # csd_train(training_data_loader, net, opt)

    # test model
    # for i in testing_data_loader.create_dict_iterator():
    #     print(i["input"].shape, i["target"].shape)
    #     print(model(i["input"]), model(i["input"], 0.25))
    #     break
